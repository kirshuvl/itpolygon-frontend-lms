...
import type { SingleChoiceQuestionStepBodyInterface, UserAnserForSingleChoiceSuestionStepInterface } from '../../../types/steps'
...
export const UserAnswer: Component<UserAnswerProps> = (props) => {
    ...
    return (
        <>
            <div class={clsx(styles.answer)}>
                ...
                <div class={clsx(styles.date)}>{day}.{month}.{year} {hours}:{minutes}</div>
